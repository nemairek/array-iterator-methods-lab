...
// - For each inventor, return an object in the format { first: "First N(ame", last: "Last Name" }.
...
let firstLast = people.map(function(person) {
  let splitNames = person.split(',') 
  let lastName = splitNames[0]
  let firstName =splitNames[1]
